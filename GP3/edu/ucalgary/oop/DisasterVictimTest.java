...
public class DisasterVictimTest {
    private Person disasterVictim;
    private ArrayList<Supply> personalBelonging;
    ...
    @Before
    public void setUp() {
        disasterVictim = new Person(expectedFirstName, EXPECTED_ENTRY_DATE);
        personalBelonging = new ArrayList<>();
        personalBelonging.add(new Supply("Water Bottle", 10));
        personalBelonging.add(new Supply("Blanket", 5));

        Person victim1 = new Person("Jane", "2024-01-20");
        Person victim2 = new Person("John", "2024-01-22");
